...
import { TableIntegrationsProps } from "./TableIntegratipn.types"
...
const data: TableIntegrationsProps[] = [
  ...
  export const columns: ColumnDef<TableIntegrationsProps>[] = [
    ...
    },
    {
      ...
      header: "APPLICATION",
      cell: ({ row }) => (
        <div className="capitalize">{row.getValue("app")}
        </div>
      ),
    },
    {
      accessorKey: "type",
      header: () => <div> TYPE </div>,     
      cell: ({ row }) => <div className="lcapitañize">{row.getValue("type")}</div>,
    },
    {
      accessorKey: "rate",
